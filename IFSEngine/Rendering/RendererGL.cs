...
public sealed class RendererGL : IAsyncDisposable
{
    ...
    private void InitTonemapPass()
    {
        ...
        GL.TexParameter(TextureTarget.Texture2D, TextureParameterName.TextureBorderColor, _bufferClearColor);
    ...
    private void ApplyPostFxPasses()
    {
        ...
        for (int i = 0; i < enabledLayers.Count; i++)
        {
            ...
            GL.Uniform1(GL.GetUniformLocation(programHandle, "palette_colors_count"), LoadedParams.Palette.KeyColors.Count);
