...
namespace IFSEngine
{
    public class RendererGL
    {
        ...
        private void UpdatePointsState()
        {
            ...
            GL.BufferData(BufferTarget.ShaderStorageBuffer, 4 * ThreadCount * sizeof(float), StartingDistributions.UniformUnitCube(ThreadCount), BufferUsageHint.DynamicCopy);
        }
        ...
        public void RenderFrame()
        {
            ...
            if (invalidAccumulation)
            {
                ...
                if (invalidParams)
                {
                    ...
                    GL.BufferData(BufferTarget.ShaderStorageBuffer, ThreadCount * sizeof(int), IntPtr.Zero, BufferUsageHint.DynamicCopy);
