...
namespace WpfDisplay.Views.Animation.Helper;

public class TimelineDrawer
{
    private readonly double _activeAreaStart;
    private readonly double _activeAreaEnd;

    public TimelineDrawer(double activeAreaStart, double activeAreaEnd)
    {
        this._activeAreaStart = activeAreaStart;
        this._activeAreaEnd = activeAreaEnd;
    }
    ...
    private double MapToActiveArea(double normalizedOriginalValue) => normalizedOriginalValue.Remap(0, 1, _activeAreaStart, _activeAreaEnd);
